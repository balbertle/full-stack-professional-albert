...
const MyDropzone = ({ customerId, fetchCustomers }) => {
    ...
    const onDrop = useCallback((acceptedFiles) => {
        ...
        uploadCustomerProfilePicture(customerId, formData)
            ...
            .catch(() => {
                errorNotification("Failure", "Profile picture failed to upload");
            });
    }, [customerId]); // ✅ correct placement of dependency array
    ...
    return (
        ...
        >
            ...
            {isDragActive
                ...
                : <p>Drag 'n' drop your picture here, or click to select the picture</p>}
        </Box>
    );
};
